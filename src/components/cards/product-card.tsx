      ...
      <div className="relative">
        ...
        <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-3 px-4 py-3 text-white">
          ...
          <Link
            ...
            className="shrink-0 rounded-full border border-white/70 px-3 py-1 text-[0.5rem] font-semibold uppercase tracking-[0.28em] transition hover:border-white hover:bg-white/10 sm:text-[0.55rem]"
          >
