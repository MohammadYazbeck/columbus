  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/40 via-black/5 to-transparent" />
        <div className="absolute inset-x-0 bottom-0 flex items-center justify-between px-5 py-4 text-white">
          ...
          <Link
            ...
            className="rounded-full border border-white/70 px-4 py-1 text-[0.55rem] font-semibold uppercase tracking-[0.35em] transition hover:border-white hover:bg-white/10"
          >
